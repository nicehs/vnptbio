...
output "license_server_ssm_role_name" {
  value = aws_iam_role.license_server_ssm_role.name
}

output "license_server_ssm_profile_name" {
  value = aws_iam_instance_profile.license_server_ssm_profile.name
}